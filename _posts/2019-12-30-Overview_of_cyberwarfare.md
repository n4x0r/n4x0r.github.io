---
layout: article
title:  "A brief reference on Russia's approach to Cyber"
...
From the beginning of malware existence, it's been usually designed towards accomplishing monetary driven objectives or just to trash systems and generally wreak havoc. This is still the case with most malware within the cybercrime ecosystem.
...
This specific change in ecosystem does not only implies that better understanding of specific tactics and techniques leveraged by this new malware genre is necessary, but also implies that in order to interpret and analyze cyber-espionage operations, development of a different mindset is required since threat actors conducting these operations are of higher profile having more resources, bigger budgets and different objectives than cyber-crime actors, and their campaigns can also be ambiguous to interpret along with their attribution.
...
However, for analyst sometimes is of interest to know what country or entity is behind a campaign, only to understand the motive or narrative that explains how a specific tool-sets come into play. As this domain grows and matures over time, I also personally think is important to have some historic context of various noticeable events that have took place in the cyber warfare realm, in order to shape our perspective of the state-of-the-art as-well as to understand what has be done in the ecosystem in order to be able to predict future trends.
...
## **Foundation**  
Is important to interpret Cyber-Warfare as the fifth domain of warfare. In contrast with more conventional warfare domains such as Land, Sea, Air or Space, the 5th domain provides a wide range of capabilities that the previous domains can't provide, also subject to different rules which do not align with previously known strategic basis of the warfare realm.
...
- High innovation involved: Accomplishing strategic goals leveraging different operational objectives can often represent a challenge since it is `highly unlikely that leveraged tactics and techniques will succeed twice`.
 ...
 Philosophically speaking, this 5th domain provides the following capabilities in regards to what kind of activities can be leveraged:
...
* **Cognitive** - Ability to modify a target's behavior with information - Based on the same foundations as Marketing or Propaganda. Not restricted to distribution of untruthful information or disinformation, sometimes a target's behavior can be changed by supplying unknown truths. I highly suggest reading about Reflexive Control Theory to know more about the strategies that can be applied with these specific types of operations. Some examples are such as Guccifer 2.0, DCLeaks or the Shadow Brokers.
...
This is an important factor to understand in order to make sense of the dynamics of this domain in terms of tool-sets, team capacity and efficacy of operations.
...
*   [Fancy Bear](https://www2.fireeye.com/rs/fireye/images/rpt-apt28.pdf)
*   [Cozy Bear](https://www2.fireeye.com/rs/848-DID-242/images/rpt-apt29-hammertoss.pdf)
*   [Venomous Bear](https://www.first.org/resources/papers/tbilisi2014/turla-operations_and_development.pdf)
...
*   [Primitive Bear](https://www.securityweek.com/russian-gamaredon-hackers-back-targeting-ukraine-officials?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed%3A+Securityweek+%28SecurityWeek+RSS+Feed%29)

There has been some speculation in private industry in terms of attribution and on how these groups map to specific Russian government agencies. Some public industry entities such as the Estonian intelligence service have helped brought some light into this topic. From [this](https://www.valisluureamet.ee/pdf/raport-2018-ENG-web.pdf) unclassified report from 2018, we can find this diagram that tries to map each specific cyber team, with its responsible intelligence unit within the Russian government:

<br/>
<div style="text-align:center"><img src ="https://dd80b675424c132b90b3-e48385e382d2e5d17821a5e1d8e4c86b.ssl.cf1.rackcdn.com/files/images_articles/checkptrussia.jpg" /></div>
<br/>
...
This shows great creativity capacity, being Russian threat actors some of the `first publicly known actors to have leveraged false flags` on a tactical level to disrupt direct attribution.
